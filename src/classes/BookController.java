...
public class BookController {
    ...
    public void addDummies() { // function to add dummy data when program started
        this.books.add(new Book("ISBN 123-123-123-123-1", "Book 1", "Farhan", 2020));
        this.books.add(new Book("ISBN 123-123-123-123-2", "Book 2", "Farhan", 2020));
        this.books.add(new Book("ISBN 123-123-123-123-3", "Book 3", "Farhan", 2020));
        this.books.add(new Book("ISBN 123-123-123-123-4", "Book 4", "Farhan", 2020));
        this.books.add(new Book("ISBN 123-123-123-123-5", "Book 5", "Farhan", 2020));
        this.books.add(new Book("ISBN 123-123-123-123-6", "Book 6", "Farhan", 2020));
    }
