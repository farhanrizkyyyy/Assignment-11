...
public class UserController {
    ...
    public void addDummies() { // function to add dummy data when program started
        this.users.add(new User("farhan1", "Farhan"));
        this.users.add(new User("farhan2", "Farhan"));
        this.users.add(new User("farhan3", "Farhan"));
        this.users.add(new User("farhan4", "Farhan"));
    }
}
