...
public class Main {
    ...
    final static String[] mainMenu = {"Book Management", "User Management", "Borrow & Lend Book", "Transaction History"}; // initiate main menu title
